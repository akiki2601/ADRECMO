...
fig_IL6 <- fig_IL6 + theme(legend.position = "below")
...
#FIGURE 3-5 fusion: IL6 and outcomes and survival

```{r}
Figure6_7_combined <- (fig_IL6) | (Figure_7_full) +
  plot_annotation( tag_levels = c("A","B"))

ggsave("FIGURES/Figure6_7_combined.pdf",
       plot   = Figure6_7_combined,
...
F17_1_plot <- make_il_cor_plot(df, 
...
F17_2_plot <- make_il_cor_plot(df, 
...
F17_3_plot <- make_il_cor_plot(df, 
...
F17_4_plot <- make_il_cor_plot(df, 
...
F17_5_plot <- make_il_cor_plot(df, 
...
F17_6_plot <- make_il_cor_plot(df, 
...
F18_1_plot <- make_il_cor_plot(df, 
...
F18_2_plot <- make_il_cor_plot(df, 
...
F18_3_plot <- make_il_cor_plot(df, 
...
F18_4_plot <- make_il_cor_plot(df, 
...
F18_5_plot <- make_il_cor_plot(df, 
...
F18_6_plot <- make_il_cor_plot(df, 
...
F19_1_plot <- make_il_cor_plot(df, 
                               "ADR1L_J0",
                 "log_value_IL10_J0",
                 xlab = "log(IL-10 + 1)",
                 ylab = "Percentage of T lymphocytes\nexpressing ADRB1",
...
F19_2_plot <- make_il_cor_plot(df, 
                 "ADR1L_J3_J5",
...
F19_3_plot <- make_il_cor_plot(df, 
                 "ADR1L_JS",
                 "log_value_IL10_JS",
                 xlab = "log(IL-10 + 1)",
                 ylab = "Percentage of T lymphocytes\nexpressing ADRB1",
...
F19_4_plot <- make_il_cor_plot(df, 
                 "ADR2L_J0",
                 "log_value_IL10_J0",
                 xlab = "log(IL-10 + 1)",
                 ylab = "Percentage of T lymphocytes\nexpressing ADRB2",
...
F19_5_plot <- make_il_cor_plot(df, 
                 "ADR2L_J3_J5",
                 "log_value_IL10_J3_J5",
                 xlab = "log(IL-10 + 1)",
                 ylab = "Percentage of T lymphocytes\nexpressing ADRB2",
...
F19_6_plot <- make_il_cor_plot(df, 
                 "ADR2L_JS",
                 "log_value_IL10_JS",
                 xlab = "log(IL-10 + 1)",
                 ylab = "Percentage of T lymphocytes\nexpressing ADRB2",
...
F20_1_plot <- make_il_cor_plot(df, 
...
F20_2_plot <- make_il_cor_plot(df, 
...
F20_3_plot <- make_il_cor_plot(df, 
                 "M_ADR1_JS", "log_value_IL10_JS",
                 xlab = "log(IL-10 + 1)",
                 ylab = "Percentage of monocytes\nexpressing ADRB1",
                 title_lab = "C: D weaning",
                 ylim = c(0, 100))
F20_4_plot <- make_il_cor_plot(df, 
...
F20_5_plot <- make_il_cor_plot(df, 
...
F20_6_plot <- make_il_cor_plot(df, 
