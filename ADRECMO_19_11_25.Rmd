...
(log scale)"
  ...
  annotate("text", x = 2, y = min(prep_M1$data$value, na.rm = TRUE), label = test_M1$label, hjust = 0)
...
(log scale)",
  ...
  annotate("text", x = 1, y = min(prep_M2$data$value, na.rm = TRUE)+1, label = test_M2$label, hjust = 0)
