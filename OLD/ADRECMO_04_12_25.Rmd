...
prep_A1 <- prep_marker_data(df, prefix = "ADR1L", transform = "log10")
...
prep_A2 <- prep_marker_data(df, prefix = "ADR2L", transform = "log10")
...
(log scale)"
  ...
  annotate("text", x = 1, y = min(prep_A2$data$value_log, na.rm = TRUE) +1, label = test_A2$label, hjust = 0)

prep_M1 <- prep_marker_data(df, prefix = "M_ADR1", transform = "log10")
...
(log scale)"
  ...
  annotate("text", x = 2, y = min(prep_M1$data$value_log, na.rm = TRUE), label = test_M1$label, hjust = 0)

prep_M2 <- prep_marker_data(df, prefix = "M_ADR2", transform = "log10")
...
(log scale)",
  ...
  annotate("text", x = 1, y = min(prep_M2$data$value_log, na.rm = TRUE), label = test_M2$label, hjust = 0)
...
ggplot(df, aes(x = log_value_IL6_D0, y = j0_ecmo_debit)) +
  geom_point() +
...
MW <- wilcox.test(log_value_IL6_D0~autre_riph_interv, df)
p <- MW$p.value
Figure15 <- ggplot(df,aes(y=log_value_IL6_D0, x=as.factor(autre_riph_interv),fill=as.factor(autre_riph_interv)))+
  geom_boxplot()+
   annotate("text",
            x = 1,
      y = 8,
...
F17_1_plot <- make_il6_cor_plot(data= df,
                   xvar= "log_value_IL6_D0",
                   yvar = "log10_ADR1L_J0",
                   ylab= "Percentage of T lymphocytes\nexpressing ADRB1 (log 10 scale)",
                   title_lab = "A: D0")


F17_2_plot <- make_il6_cor_plot(data= df,
                   xvar= "log_value_IL6_J3_J5",
                   yvar = "log10_ADR1L_J3_J5",
                   ylab= "Percentage of T lymphocytes\nexpressing ADRB1 (log 10 scale)",
                   title_lab = "B: D3-D5")

F17_3_plot <- make_il6_cor_plot(data= df,
                   xvar= "log_value_IL6_JS",
                   yvar = "log10_ADR1L_JS",
                   ylab= "Percentage of T lymphocytes\nexpressing ADRB (log 10 scale)",
                   title_lab = "B: D weaning")


F17_4_plot <- make_il6_cor_plot(data= df,
                   xvar= "log_value_IL6_D0",
                   yvar = "log10_ADR2L_J0",
                   ylab= "Percentage of T lymphocytes\nexpressing ADRB2 (log 10 scale)",
                   title_lab = "A: D0")


F17_5_plot <- make_il6_cor_plot(data= df,
                   xvar= "log_value_IL6_J3_J5",
                   yvar = "log10_ADR2L_J3_J5",
                   ylab= "Percentage of T lymphocytes\nexpressing ADRB2 (log 10 scale)",
                   title_lab = "B: D3-D5")

F17_6_plot <- make_il6_cor_plot(data= df,
                   xvar= "log_value_IL6_JS",
                   yvar = "log10_ADR2L_JS",
                   ylab= "Percentage of T lymphocytes\nexpressing ADRB2 (log 10 scale)",
                   title_lab = "B: D weaning")
...
F18_1_plot <- make_il6_cor_plot(data= df,
                   xvar= "log_value_IL6_D0",
                   yvar = "log10_M_ADR1_J0",
                   ylab= "Percentage of T monocytes\nexpressing ADRB1 (log 10 scale)",
                   title_lab = "A: D0")


F18_2_plot <- make_il6_cor_plot(data= df,
                   xvar= "log_value_IL6_J3_J5",
                   yvar = "log10_M_ADR1_J3_J5",
                   ylab= "Percentage of T monocytes\nexpressing ADRB1 (log 10 scale)",
                   title_lab = "B: D3-D5")

F18_3_plot <- make_il6_cor_plot(data= df,
                   xvar= "log_value_IL6_JS",
                   yvar = "log10_M_ADR1_JS",
                   ylab= "Percentage of T monocytes\nexpressing ADRB (log 10 scale)",
                   title_lab = "B: D weaning")


`F18_4_plot` <- make_il6_cor_plot(data= df,
                   xvar= "log_value_IL6_D0",
                   yvar = "log10_M_ADR2_J0",
                   ylab= "Percentage of T monocytes\nexpressing ADRB2 (log 10 scale)",
                   title_lab = "A: D0")


F18_5_plot <- make_il6_cor_plot(data= df,
                   xvar= "log_value_IL6_J3_J5",
                   yvar = "log10_M_ADR2_J3_J5",
                   ylab= "Percentage of T monocytes\nexpressing ADRB2 (log 10 scale)",
                   title_lab = "B: D3-D5")

F18_6_plot <- make_il6_cor_plot(data= df,
                   xvar= "log_value_IL6_JS",
                   yvar = "log10_M_ADR2_JS",
                   ylab= "Percentage of T monocytes\nexpressing ADRB2 (log 10 scale)",
                   title_lab = "B: D weaning")
