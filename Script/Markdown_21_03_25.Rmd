...
table2b <- df_long %>%
  ...
  mutate(Value_IQR = paste0(Median, " [", Q1, "–", Q3, "]")) %>%
...
# No significant correlation was observed between ADRB1 l and heart rate. This suggests that, in this context, the expression of β1-adrenoreceptors on T lymphocytes is not associated with variations in heart rate at any time.
