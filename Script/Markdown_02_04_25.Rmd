...
df_long <- df %>%
  ...
  rename(
    ...
    `Noradrenalin (mg)` = jsev_epr_sev_t0_3l_NAd_w,
    `VTI_1.5L (cm)` = `jsev_epr_sev_t1_1,5l_itv`,
    `MAP_1.5L (mmHg)` = `jsev_epr_sev_t1_1,5l_pam`,
    `Noradrenalin_1.5L (mg)` = `jsev_epr_sev_t1_1,5l_NAd_w`
  ) %>%
  pivot_longer(
...
# NO significant difference between VTI at 3L and 1.5 L (p-value = 0.5204).
